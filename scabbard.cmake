...
function(scabbard_check_default_stream_flag target)
    ...
    if("--default-stream" IN_LIST CURRENT_FLAGS OR "-default-stream" IN_LIST CURRENT_FLAGS)
    ...
    elseif("--default-stream=per-thread" IN_LIST CURRENT_FLAGS OR "-default-stream=per-thread" IN_LIST CURRENT_FLAGS)
        set(SCABBARD_HIP_DEFAULT_STREAM "-D__SCABBARD_HIP_DEFAULT_STREAM__=2u")
    else()
        set(SCABBARD_HIP_DEFAULT_STREAM "-D__SCABBARD_HIP_DEFAULT_STREAM__=1u")
    endif()
